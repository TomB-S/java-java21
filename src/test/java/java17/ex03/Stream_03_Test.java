...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().collect(Collectors.maxBy(Comparator.comparing(order -> order.getPrice())));
	...
	public void test_min() throws Exception {
		...
		Optional<Order> result = orders.stream().collect(Collectors.minBy(Comparator.comparing(order -> order.getPrice())));
